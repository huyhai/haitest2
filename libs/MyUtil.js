import React, {StyleSheet, Dimensions, PixelRatio,AlertIOS} from "react-native";
const {width, height, scale} = Dimensions.get("window"),
    ...
    export function getDefauldParams(api){
      var formBody = [];
      ...
      var hash = md5(api + 'android' + GLOBAL.PRIVATE_KEY +  Math.floor(Date.now() / 1000)+ GLOBAL.APPVERVALUE);
    ...
    export function showIOSAlert(message){
      AlertIOS.alert(
        "POST",
        "Message: " + message
      )
